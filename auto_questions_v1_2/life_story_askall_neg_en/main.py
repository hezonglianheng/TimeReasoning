...
if __name__ == "__main__":
    ...
    # 定义场景
    # 随机抽取事件
    curr_scene = scene.LineScene(ts.TimeScale.Year, "Jack's daughter is telling her friends about the story of his life", ask_mode='deepest', lang="en")
    ...
    for s in samples:
        ...
        # 运行时间场景
        res.extend(curr_scene.run_ask_all(1, ask_correct=False))
        curr_scene.reset()
